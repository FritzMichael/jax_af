...
from warp_kernel_impl.wrapper import run_BP, run_jax_BP_auto_backward, run_jax_BP
...
output_image, entropy, grad, (jitted_function, jax_args) = run_jax_BP_auto_backward(
    pixel_pos=grid,
    range_profiles=rp,
    radar_pos=rad_pos,
    radar_vel=rad_vel,
